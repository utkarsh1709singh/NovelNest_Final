...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['remove_book_id'])) {
    if (isset($_SESSION['user_id'])) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<p>Error removing book from wishlist: " . $stmt->error . "</p>";
        }
            ...
            <div class="book-details-container">
                ...
                <div class="book-info">
                    ...
                    <?php if (isset($_SESSION['session_token'])): ?>
                        <form action="view-wishlist-book.php?id=<?php echo $book_id; ?>" method="post" class="remove-form">
                    ...
                    <?php else: ?>
                        <p>Please <a href="login.php">log in</a> to manage your wishlist.</p>
                    <?php endif; ?>
                </div>
            </div>
        </section>
